...
export const metadata: Metadata = {
  title: "Restaurant AI Agent — System & Tenant Status",
  description: "Phase 2 Database & Restaurant Foundation for Restaurant AI Agent",
};
    ...
    <html lang="en">
      <body className="antialiased">
        ...
        <footer className="border-t border-slate-200 dark:border-slate-800 py-6 mt-12 text-center text-xs text-slate-500">
          Restaurant AI Agent &copy; {new Date().getFullYear()} &middot; Phase 2 Multi-Tenant Foundation
        </footer>
      </body>
    </html>
  );
